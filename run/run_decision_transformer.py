...
def train_model():
    ...
    replay_buffer = EpisodeReplayBuffer(16, 1, data_path = "./data/trajectory/data_1.pickle")
    # replay_buffer = EpisodeReplayBuffer(16, 1, data_path = "./data/trajectory/tmp.csv")
